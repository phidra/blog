...
* présentation propre de la programmation dynamique
* fait écho au cours d'Erik DEMAINE annoté ci-dessous
...
* ...si on n'a pas de pot, on parcourera tout le tableau ou presque avant de le trouver → O(N)
